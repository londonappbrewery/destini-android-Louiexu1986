        ...
        mTopButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mStoryIndex == 1||mStoryIndex == 2)
                {
                    ...
                    mTopButton.setText(getResources().getString(R.string.T3_Ans1));
                    mBottomButton.setText(getResources().getString(R.string.T3_Ans2));
                    mStoryIndex = 3;
        ...
        mBottomButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mStoryIndex == 1)
                {
                    ...
                    mTopButton.setText(getResources().getString(R.string.T2_Ans1));
                    mBottomButton.setText(getResources().getString(R.string.T2_Ans2));
                    mStoryIndex = 2;
